...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-900">
      <Navbar />
      ...
      <main className="flex-1 w-full">
        ...
        <section className="mx-auto w-[85%] max-w-[1500px] px-4 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-normal text-slate-800 tracking-tight">
              Ropa <span className="font-semibold text-slate-950">Térmica</span>
            </h2>
          </div>
        ...
        <section className="mx-auto w-[85%] max-w-[1500px] px-4 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-normal text-slate-800 tracking-tight">
              Ropa <span className="font-semibold text-slate-950">Ignifuga</span>
            </h2>
          </div>
        ...
        <section className="mx-auto w-[85%] max-w-[1500px] px-4 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-normal text-slate-800 tracking-tight">
              Ropa Jean <span className="font-semibold text-slate-950">Industrial</span>
            </h2>
          </div>
        ...
        <section className="mx-auto w-[85%] max-w-[1500px] px-4 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-normal text-slate-800 tracking-tight">
              Calzado <span className="font-semibold text-slate-950">Industrial</span>
            </h2>
          </div>
        ...
        <section className="mx-auto w-[85%] max-w-[1500px] px-4 py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-normal text-slate-800 tracking-tight">
              Implementos de <span className="font-semibold text-slate-950">Seguridad</span>
            </h2>
          </div>
