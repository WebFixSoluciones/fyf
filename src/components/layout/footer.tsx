...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0a0f1d] text-slate-400 mt-auto border-t border-slate-800 font-sans text-xs">
      {/* 1. Value Props / Trust Strip (E-Commerce Pillars) */}
      <div className="border-b border-slate-800/80 py-8 bg-[#0f172a]/60">
        <div className="mx-auto w-[85%] max-w-[1500px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-3.5">
            <div className="size-11 rounded-xl bg-slate-900 border border-slate-800 text-[#ff6600] flex items-center justify-center shrink-0">
              <Truck className="size-5" />
            </div>
            <div>
              <h4 className="text-white text-xs sm:text-[13px] font-medium tracking-tight">Envíos a Todo el Ecuador</h4>
              <p className="text-[11px] text-slate-400 mt-0.5">Servientrega, LaarCourier y carga</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">Precios al por mayor y menor</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">Prendas y calzado certificados</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">Atención y cotizaciones vía WhatsApp</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-slate-800/80 py-8 bg-[#0a0f1d]">
        <div className="mx-auto w-[85%] max-w-[1500px] flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-900/90 border border-slate-700 rounded-xl px-4 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-[#ff6600] transition-colors"
                />
                <button
                  type="submit"
      ...
      <div className="py-12 border-b border-slate-800/80">
        <div className="mx-auto w-[85%] max-w-[1500px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 leading-relaxed">
          {/* Brand Info */}
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="relative size-11 rounded-full overflow-hidden border border-slate-700 bg-white shrink-0">
          ...
          <div>
            <h4 className="text-white font-medium text-xs uppercase tracking-wider mb-3.5 text-slate-200">
              Categorías
            </h4>
              ...
              {CATEGORIES_DATA.map((cat) => (
                <li key={cat.slug}>
                  <Link
                    ...
                    className="text-slate-400 hover:text-white transition-colors block uppercase tracking-wider"
                  >
                    {cat.name}
                  </Link>
                </li>
      ...
      <div className="py-6 bg-[#070b16]">
        <div className="mx-auto w-[85%] max-w-[1500px] flex flex-col md:flex-row items-center justify-between gap-4 text-[11px]">
